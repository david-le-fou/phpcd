...
class Controll{
    ...
    public function application(){
        ...
        if (isset($_POST['attribut'])&& isset($_POST['description_attr'])):
            $data_attribut = array('valeur'=>trim($_POST['attribut']),
                            'description'=>trim($_POST['description_attr']));
        ...
        if(isset($_POST['valeur'])&& isset($_POST['description_val']) && isset($_POST['attr_select'])):
            ...
            $data = array('valeur'=>trim($_POST['valeur']),
                    'description'=>trim($_POST['description_val']),
